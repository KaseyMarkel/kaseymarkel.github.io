...
{{< rawhtml >}}
<style>
.living-wall-photo-grid {
  display: grid;
  grid-template-columns: repeat(2, 1fr);
  gap: 15px;
  margin: 20px 0;
}
.living-wall-photo-grid img {
  width: 100%;
  height: auto;
  border-radius: 8px;
...
<div class="living-wall-photo-grid">
  <img src="/img/PW1.jpg" alt="Living Wall">
  <img src="/img/PW2.jpg" alt="Living Wall design">
</div>
{{< /rawhtml >}}
...
{{< rawhtml >}}
<div class="living-wall-photo-grid">
  <img src="/img/PW3.jpg" alt="Watering system">
  <img src="/img/PW4.jpg" alt="Construction detail">
</div>
{{< /rawhtml >}}
...
{{< rawhtml >}}
<div class="living-wall-photo-grid">
  <img src="/img/PW5.jpg" alt="Redwood construction">
  <img src="/img/PW6.jpg" alt="Plants growing">
</div>
{{< /rawhtml >}}
...
{{< rawhtml >}}
<div class="living-wall-photo-grid">
  <img src="/img/PW7.jpg" alt="Completed living wall">
</div>
{{< /rawhtml >}}
